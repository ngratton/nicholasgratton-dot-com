...
const init = ()=>{
    (0, _animate.animateHomeBackground)();
    (0, _animate.animateProfessionText)();
    (0, _animate.animateIntroText)();
    (0, _animate.animateIntroPhotos)();
    (0, _animate.animateIntroIcons)();
    (0, _animate.animateNameText)();
    (0, _animate.animateSkillTags)();
    (0, _animate.animateJobCards)();
};
/* Wait for DOM to be loaded  */ window.addEventListener("DOMContentLoaded", ()=>{
    init();
});

},{"./animate":"4EYNw"}],"4EYNw":[function(require,module,exports,__globalThis) {
// eslint-disable-next-line import/extensions
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "animateHomeBackground", ()=>animateHomeBackground);
parcelHelpers.export(exports, "animateProfessionText", ()=>animateProfessionText);
parcelHelpers.export(exports, "animateNameText", ()=>animateNameText);
parcelHelpers.export(exports, "animateIntroText", ()=>animateIntroText);
parcelHelpers.export(exports, "animateIntroPhotos", ()=>animateIntroPhotos);
parcelHelpers.export(exports, "animateIntroIcons", ()=>animateIntroIcons);
parcelHelpers.export(exports, "animateSkillTags", ()=>animateSkillTags);
parcelHelpers.export(exports, "animateJobCards", ()=>animateJobCards);
var _gsap = require("gsap");
var _scrambleTextPlugin = require("gsap/ScrambleTextPlugin");
var _splitText = require("gsap/SplitText");
var _scrollTrigger = require("gsap/ScrollTrigger");
(0, _gsap.gsap).registerPlugin((0, _scrambleTextPlugin.ScrambleTextPlugin), (0, _splitText.SplitText));
(0, _gsap.gsap).registerPlugin((0, _scrollTrigger.ScrollTrigger));
const animateHomeBackground = ()=>{
    (0, _gsap.gsap).from("#home-background", {
        opacity: 0.5,
        scale: 1.5,
        duration: 5,
        rotate: 10,
...
const animateProfessionText = ()=>{
    (0, _gsap.gsap).from("#profession-text", {
        opacity: 0,
        y: 50,
        duration: 1,
        ease: "power2.out",
...
const animateNameText = ()=>{
    (0, _splitText.SplitText).create("#header h1", {
        type: "chars",
        autoSplit: true,
        onSplit (self) {
            return (0, _gsap.gsap).from(self.chars, {
                duration: 0.7,
                fontWeight: 700,
                delay: 0.2,
                ease: "power2.out",
...
const animateIntroText = ()=>{
    ...
    paragraphs.forEach((p)=>{
        (0, _splitText.SplitText).create(p, {
            type: "lines",
            autoSplit: true,
            onSplit (self) {
                return (0, _gsap.gsap).from(self.lines, {
                    duration: 0.5,
                    opacity: 0,
                    y: 20,
                    ease: "power2.out",
...
const animateIntroPhotos = ()=>{
    ...
    photos.forEach((photo, index)=>{
        ...
        photo.addEventListener("mouseover", (event)=>{
            (0, _gsap.gsap).to(event.currentTarget, {
                duration: 0.5,
                scale: 1.2,
                ease: "power2.out",
                zIndex: 99
...
const animateJobCards = ()=>{
    ...
    jobCards.forEach((card)=>{
        ...
        (0, _gsap.gsap).from(jobCardsWithImage, {
            duration: 1,
            backgroundSize: "fill",
            ease: "power2.out",
            scrollTrigger: {
...
},{"gsap":"9F7Z6","gsap/ScrambleTextPlugin":"dbPef","gsap/SplitText":"9G4cn","gsap/ScrollTrigger":"372oo","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"9F7Z6":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./gsap-core.js":"evdHe","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"dbPef":[function(require,module,exports,__globalThis) {
/*!
...
},{"./utils/strings.js":"bvH2e","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"bvH2e":[function(require,module,exports,__globalThis) {
/*!
 * strings: 3.14.2
 * https://gsap.com
 *
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"372oo":[function(require,module,exports,__globalThis) {
/*!
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["bJyex","iIYEz"], "iIYEz", "parcelRequire76d7", {})

//# sourceMappingURL=nicholasgratton-dot-com.114e39af.js.map
